...
receivers = ['1083298593@qq.com',
             # 'liuyujing@xywy.com','liuyipeng@xywy.com','maningbo@xywy.com','liangyanyan@xywy.com','wangxinyi@xywy.com'
...
if __name__ == '__main__':
    sendEmail('十万关键词数据灌贴项目', '数据已处理并提供，数据量：67584')
